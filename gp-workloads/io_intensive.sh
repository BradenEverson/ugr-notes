...
echo "These tests focus on disk and filesystem operations"
echo ""
sleep 2
...
echo "Expected syscalls: read, write, open, openat, close, fsync, sync,"
echo "                  stat, fstat, getdents, mkdir, rmdir, rename, unlink,"
echo "                  mmap, munmap, lseek, flock, link, symlink"
